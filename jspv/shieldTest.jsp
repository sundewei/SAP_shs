...
<body>	
                        ...
                        <table class='fileBrowser'>
							...
							<tr align="left">
								<td colspan="3">
									<table>
										<tr>
											<td><img src="/shs/resources/gfx/icon-whitearrowright.png"><img src="/shs/resources/gfx/icon-whitearrowright.png"><img src="/shs/resources/gfx/icon-whitearrowright.png"><b>DemoSensorData:</b></td>
											<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="tableStatus"></span></td>
											<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="responseStatus" class="messageBox"></span></td>
										</tr>
									</table>
								</td>
							</tr>
                            ...
                            <tr>
                                <td valign="top" class="boxed">
                                    ...
                                    <div id="oilSensors">
                                        <table>
											<tr><td class="boxed" colspan="3" >Oil/Gas Sensors&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="oilSensorSwitch" onclick="startOil()" /><input type="button" id="oilSensorSwitchOff" onclick="stopOil()" /></td></tr>
                                ...
                                <td valign="top" colspan="2" class="boxed">
									<div id="windmillSensors">
                                        <table>
											<tr><td class="boxed" colspan="4">Windmill Farm Sensors &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="windmillSensorSwitch" onclick="startWindmill()" /><input type="button" id="windmillSensorSwitchOff" onclick="stopWindmill()" /></td></tr>
    ...
    <script>
        ...
        $(function () {			
			...
			$('#oilSensorSwitchOff').hide();
			$('#windmillSensorSwitchOff').hide();
        });
    </script>
</body>
</html>